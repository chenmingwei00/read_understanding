        ...
        for line in tqdm(lines):
            try:
                ...
                if len(context_tokens)>size:
                    ...
                    context_tokens,context_pos =jieba_pos(context_tokens)
                ...
                if np.sum(ys1)==1:
                    ...
                    #     continue
                    # else:
                    example = {"context_tokens": context_tokens,"context_pos":context_pos, "context_chars": context_chars, "ques_tokens": ques_tokens,\
                               'ques_pos':ques_pos,"alternatives_tokens":np.array(new_alternative),
    ...
    with open(filename, "r") as fh:
        ...
        for line in tqdm(lines):
            try:
                ...
                example = {"context_tokens": context_tokens,'context_pos':context_pos, "context_chars": context_chars,\
                           "ques_tokens": ques_tokens,'ques_pos':ques_pos,"ques_chars": ques_chars,
