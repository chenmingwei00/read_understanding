...
def get_record_parser(config, is_test=False):
    def parse(example):
        ...
        if is_test!=True:
            ...
            return context_idxs,context_pos_idxs, ques_idxs,ques_pos_idxs,context_char_idxs, ques_char_idxs,y1, qa_id,alternatives_tokens
        else:
            return context_idxs,context_pos_idxs,ques_idxs,ques_pos_idxs,context_char_idxs, ques_char_idxs,alternatives_tokens
    return parse
