...
target_dir = "/disk/chenmingwei/cnn_two_embedding/"
log_dir =os.path.join(target_dir,"lstm_model_addlstm/event")
save_dir =os.path.join(target_dir,"lstm_model_addlstm/model111111")
answer_dir = "lstm_model_addlstm/answer"
...
flags.DEFINE_string("mode", "test", "train/debug/test/prepro")
...
flags.DEFINE_float("init_lr", 4e-4, "Initial lr for Adadelta")
